...
export default function WorkModal({isModalOpen, onModalClose, poem}: WorkModalProps) {
  return (
    <div className="w-full h-full absolute top-0 backdrop-filter backdrop-blur-sm">
        <Modal hideCloseButton={true} size="md" isOpen={isModalOpen} onClose={onModalClose} isDismissable={false} className="font-serif flex flex-column items-center rounded  mt-10 mx-10 pt-5 px-5 bg-white h-auto min-h-[30vh] max-h-[80vh]">
